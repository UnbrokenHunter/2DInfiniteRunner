...
public class Parallax : MonoBehaviour {
    ...
    float viewHeight => loopSpriteRenderer.sprite.rect.height / loopSpriteRenderer.sprite.pixelsPerUnit;
    ...
    void Awake() {
        ...
        if (loopSpriteRenderer != null && infiniteLoop) {
            ...
            loopSpriteRenderer.size = new Vector2(spriteSizeX * sizeMultiplier.x, spriteSizeY * tileWidth * sizeMultiplier.y);
    ...
    void Update() {
        ...
        if (infiniteLoop) {
            ...
            float boundsOffset = (viewHeight / 2) * (totalTravel.x > 0 ? 1 : -1);
            float screens = (int)((totalTravel.y + boundsOffset) / viewHeight);
            transform.position += new Vector3(0, screens * viewHeight);
        }
    }
